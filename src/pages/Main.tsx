...
import {
    ...
    validateIDs,
} from '../lib/storage/StarredTeacherStorage';
    ...
    return (
        <SafeAreaView className={SUCCESSFUL_SAFE_AREA_VIEW_STYLE}>
            <BottomSheetModalProvider>
                ...
                <ScrollView
                    refreshControl={ <RefreshControl colors={["rgb(250 250 250)"]} tintColor={"rgb(250 250 250)"} refreshing={ refreshing } onRefresh={ refreshFn } /> }>
